 ...
 * }
 */
public class FMOD_DSP_PAN_GETROLLOFFGAIN_FUNC {
    ...
    private static final MethodHandle UP$MH = FmodCore.upcallHandle(FMOD_DSP_PAN_GETROLLOFFGAIN_FUNC.Function.class, "apply", $DESC);
