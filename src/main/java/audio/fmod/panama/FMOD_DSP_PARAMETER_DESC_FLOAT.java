...
public class FMOD_DSP_PARAMETER_DESC_FLOAT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        FmodCore.C_FLOAT.withName("defaultval"),
        MemoryLayout.paddingLayout(4),
        FMOD_DSP_PARAMETER_FLOAT_MAPPING.layout().withName("mapping")
    ).withName("FMOD_DSP_PARAMETER_DESC_FLOAT");
    ...
    private static final OfFloat defaultval$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("defaultval"));
    ...
    private static final GroupLayout mapping$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("mapping"));
