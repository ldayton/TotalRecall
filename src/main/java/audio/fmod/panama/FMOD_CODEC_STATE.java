...
public class FMOD_CODEC_STATE {
    ...
    private static final AddressLayout waveformat$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("waveformat"));
