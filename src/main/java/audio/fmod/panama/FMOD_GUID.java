...
public class FMOD_GUID {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        FmodCore.C_INT.withName("Data1"),
        FmodCore.C_SHORT.withName("Data2"),
        FmodCore.C_SHORT.withName("Data3"),
        MemoryLayout.sequenceLayout(8, FmodCore.C_CHAR).withName("Data4")
    ).withName("FMOD_GUID");
