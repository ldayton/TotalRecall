...
public class FMOD_DSP_PARAMETER_SIDECHAIN {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        FmodCore.C_INT.withName("sidechainenable")
    ).withName("FMOD_DSP_PARAMETER_SIDECHAIN");
    ...
    private static final OfInt sidechainenable$LAYOUT = (OfInt)$LAYOUT.select(groupElement("sidechainenable"));
